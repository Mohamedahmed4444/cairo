        ...
        <div className="min-h-screen bg-gray-50">
            <div className="bg-purple-600 text-white py-12">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    ...
                    <p className="text-xl text-purple-100 mt-2">{aboutCairo.governorate}</p>
                </div>
            </div>
                ...
                <section className="mb-12">
                    ...
                    <div className="grid grid-cols-3 gap-6">
                        <div className="bg-white p-6 rounded-lg shadow-md text-center">
                            ...
                            <p className="text-2xl font-bold text-purple-600">{aboutCairo.population}</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-md text-center">
                            <strong className="block text-gray-700 mb-2">المساحة</strong>
                            <p className="text-2xl font-bold text-purple-600">{aboutCairo.area}</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-md text-center">
                            <strong className="block text-gray-700 mb-2">تأسيسها</strong>
                            <p className="text-2xl font-bold text-purple-600">{aboutCairo.established}</p>
                        </div>
                    </div>
                </section>
